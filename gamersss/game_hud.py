...
class GameHUD:
    ...
    def draw_speedometer(self, screen: pygame.Surface, pos: Tuple[int, int]):
        ...
        pygame.draw.circle(screen, (50, 50, 50), pos, 60)
        pygame.draw.circle(screen, (100, 100, 100), pos, 55)
    ...
    def draw_gear_indicator(self, screen: pygame.Surface, pos: Tuple[int, int]):
        # Draw gear indicator background
        pygame.draw.rect(screen, (50, 50, 50), (pos[0] - 30, pos[1] - 30, 60, 60))
        pygame.draw.rect(screen, (100, 100, 100), (pos[0] - 25, pos[1] - 25, 50, 50))
    ...
    def draw_fuel_meter(self, screen: pygame.Surface, pos: Tuple[int, int]):
        ...
        pygame.draw.rect(screen, (50, 50, 50), (pos[0] - 50, pos[1] - 10, 100, 20))
        
        # Draw fuel level
        fuel_width = int(96 * (self.state.fuel / 100.0))
        fuel_color = self.colors['green'] if self.state.fuel > 20 else self.colors['red']
        pygame.draw.rect(screen, fuel_color, (pos[0] - 48, pos[1] - 8, fuel_width, 16))
    ...
    def draw_mission_goals(self, screen: pygame.Surface, pos: Tuple[int, int]):
    ...
    def draw_gesture_status(self, screen: pygame.Surface, pos: Tuple[int, int]):
        ...
        screen.blit(gesture_surface, pos)
    ...
    def draw(self, screen: pygame.Surface, road_data: Dict):
        ...
        self.draw_mission_goals(screen, (20, 20))
